...
import { ImageWithLink, InsideWithLink, Product, Title, Paragraph } from "./index.js";

export const CategoryOneWithBanner = isAllowToRender(
  ({
    name,
    desc,
    href,
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <thead>
      ...
      <tr>
        <td>
          ${InsideWithLink({ insidehref: insidehref, insidesrc: insidesrc, insidealt: name })}
        </td>
      </tr>
      <tr>
        <td class="newsletterBottom35px"></td>
