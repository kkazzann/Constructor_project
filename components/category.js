...
export const Category = isAllowToRender(
  ({
    ...
    if (type === "no_products") {
      ...
      return `
                <table border="0" cellspacing="0" cellpadding="0" width="100%" style="background-color: ${background_color}">
                  <thead>
                    <tr>
                      <td style="padding-top: 0px; padding-bottom: 0px; background-color: ${background_color}" class="newsletterContainer">
                        ${Title({ title: name, align: "left", color: color })}
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <tr>
                                   ...
                                   <tr>
                                    <td style="padding-top: 0px; padding-bottom: 0px; background-color: ${background_color}">
                                      ${Paragraph({ paragraph: name_p, align: "left", color: color })}
                              ...
                              <table border="0" cellspacing="0" cellpadding="0" width="100%" style="background-color: ${background_color}">
                                <thead>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    <td style="padding-top: 0px; padding-bottom: 0px; background-color: ${background_color}">
                                      ${Paragraph({ paragraph: name, align: "left", color: color })}
                                        ...
                                        <tbody>
                                          <tr>
                                            <td style="padding-top: 0px; padding-left: 0px; padding-right: 0px; text-align: center;">
                                              ${
                                                ctaComponent
                                                  ? ctaComponent(cta_href, cta)
                                                  : `
                                                  <a href="${cta_href}" style="color:${
                                                      color || "#000"
                                                    }; text-decoration: underline;">
                                                    <span class="newsletterCta">${cta}</span>
                                                  </a>
    ...
    else if (type === "no_products_only_img") {
        return `
<table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tbody>
