...
└── 📁components
    └── [reusable components like Category or Intro]
└── 📁config
    └── languages.js
    └── shops.js
└── 📁entities
    ...
    └── SlugImage.js
    └── TableQuery.js
    └── TableQueryCategoryLinks.js
    └── TableQueryCategoryTitles.js
    └── TableQueryCSV.js
    └── TableQueryFooter.js
    └── TableQueryHeader.js
    └── TableQueryTranslationTemplates.js
    └── TemplateLinks.js
    └── 📁Templates
        └── MondayFreebieLanding.js
        └── MondayFreebieNewsletter.js
        └── MondayNewsletter.js
└── 📁helpers
    └── computeValue.js
    └── getQueryLink.js
    └── incrementId.js
    └── isQuotaExceededError.js
    └── normalizePrice.js
    └── optimizeImage.js
    └── parsePrice.js
    └── priceFormats.js
...
└── 📁templates
    └── AdventCalendar.js
    └── CategoriesGrid.js
    └── CategoriesGridOffertPart.js
    └── CategoriesRows.js
    └── CategoriesRowsLine.js
    └── CategoriesRowsLinePriceTitle.js
    └── CategoriesRowsOfferPart.js
    └── index.js
    └── landing FGG.js
    └── landing MPG.js
    └── mondayCategories.js
    └── mondayOfferFreebiesInsideBanner.js
    └── mondayOfferFreeebies.js
    └── mondayOfferFreeebiesLines.js
    └── newsletter FGG.js
    └── TimerGIF.js
└── 📁utils
    └── config.js
