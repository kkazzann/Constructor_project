...
export async function RegularNslt({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${background}; color: #000;" id="newsletter">
        <tbody>
            ...
            <tr>
                <td class="newsletterContainer" style="color: ${offerPart?.color || "#000"};">
                    ${Space()}
                </td> 
            </tr>
            <tr>
            ...
            <tr>
                <td class="newsletterContainer" style="color: ${timer?.color || "#000"}; background-color: ${timer?.background || background};">
                    ${Timer({
                ...
                <td style="background-color: ${categories[0]?.background || background}; color: ${categories[0]?.color || "#000000"}">
                    ...
                    ${categories
                      .map((item, index) => {
                        ...
                        const background = item.background || "#FFFFFF"; // Domyślny kolor tła
                        const color = item.color || "#000000"; // Domyślny kolor tekstu
                        ...
                        <tr>
                            ...
                            ${Category({
                              ...
                              color: color,
                              type: "thursday",
                              products: categories[0]?.products?.map((prod) =>
                                getProductById(prod.id, prod.src)
                              ) || [],
                            })}
                            </td>
                        </tr>
