  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${
    background || "#ffffff"
        ...
        <tbody>
            ...
            <tr>
                <td style="background-color: #FFA18C;">
                    ${CategoryOne({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250305category_01.png",
            ...
            <tr>
                <td style="background-color: #FECD8C;">
                    ${CategoryOne({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250305category_02.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
            ...
            <tr>
                <td style="background-color: #FFA18C;">
                    ${CategoryOne({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250305category_03.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
            ...
            <tr>
                <td style="background-color: #FECD8C;">
                    ${CategoryOneLast({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250305category_04.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[4].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250305category_05.png" style="display: block;" />
                                                </a>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[5].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250305category_06.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[6].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250305category_07.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[7].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250305category_08.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
