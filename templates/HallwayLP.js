...
export async function HallwayLP({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
            ...
            <tr>
                <td style="background-color: #750000;">
                    ${CategoryOneWhite({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250212category_01.png",
            ...
            <tr>
                <td style="background-color: #F6E7E6;">
                    ${CategoryOne({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250212category_02.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
            ...
            <tr>
                <td style="background-color: #750000;">
                    ${CategoryOneWhite({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250212category_03.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
            ...
            <tr>
                <td style="background-color: #F6E7E6;">
                    ${CategoryOneLast({
                      ...
                      src: "https://upload.pictureserver.net/static/2025/250212category_04.png",
                      cta: getPhrase("Shop now"),
                      type: "wednesday",
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[4].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250212category_05.png" style="display: block;" />
                                                </a>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[5].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250212category_06.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[6].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250212category_07.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[7].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250212category_08.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
