...
export async function MoonlightLP({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
        ...
        <tbody>
            ...
            <tr>
                <td align="center">
                    ${ImageWithLink({
                        href: links[0],
                        src: "https://upload.pictureserver.net/static/2024/250108title_02.gif",
                    })}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="background-color: #FFD8A6;" class="newsletterBottom35px"></td>
            </tr>
            <tr>
                <td style="background-color: #FFD8A6;">
                    ${Category({
                      href: getCategoryLink(categories[0].href),
                      name: queries?.categories[0]
                        ? queries.categories[0]
                        : getCategoryTitle(categories[0].name),
                      src: "https://upload.pictureserver.net/static/2024/250108category_01.gif",
            ...
            <tr>
                <td style="background-color: #FFCCB7;">
                    ${Category({
                      ...
                      src: "https://upload.pictureserver.net/static/2024/250108category_02.gif",
                      cta: getPhrase("Shop now"),
                      type: "monday",
            ...
            <tr>
                <td style="background-color: #FFD8A6;">
                    ${Category({
                      ...
                      src: "https://upload.pictureserver.net/static/2024/250108category_03.gif",
                      cta: getPhrase("Shop now"),
                      type: "monday",
            ...
            <tr>
                <td style="background-color: #FFCCB7;">
                    ${Category({
                      ...
                      src: "https://upload.pictureserver.net/static/2024/250108category_04.gif",
                      cta: getPhrase("Shop now"),
                      type: "monday",
