...
export async function ModularLP({
  links,
  getProductById,
  getCategoryLink,
  getCategoryTitle,
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${
    background || "#ffffff"
        ...
        <tbody>
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="100%" >
                  <tbody>
                    <tr>
                      <td>
                        <a>
                          <video src="https://upload.pictureserver.net/static/2025/20250122video650.mp4"autoplay muted loop playsinline></video>
                        </a>
                      </td>
                    </tr>
                  </tbody>
            ...
            <tr>
                <td class="ColorSpace" style="background-color: #F6E7E6;">
                    ${Space({ className: "newsletterBottomCollor35px" })}
                </td>
            </tr>
            <tr>
                <td class="newsletterContainer" style="padding-top: 0px; padding-bottom: 0px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td align="left" style="color: #000000;">
                                    <span class="newsletterParagraph">${queries.intro[0]}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr>
                <td class="ColorSpace" style="background-color: #F6E7E6;">
                    ${Space({ className: "newsletterBottomCollor25px" })}
                </td>
            </tr>
            <tr>
                <td class="ColorSpace" style="background-color: #F6E7E6;">
                ...
                <td class="newsletterContainer" style="padding-top: 0px; padding-bottom: 0px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td align="left" style="color: #000000;">
                                    <span class="newsletterParagraph">${queries.intro[2]}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td style="padding-top: 0px; padding-left: 0px; padding-right: 0px; text-align: center;">
                                    <a href="${links[9]}" style="color: #000000; text-decoration: underline;">
                                        <span class="newsletterCta">${queries.shopnow[0]}</span>
                                    </a>
                                </td>
                            </tr>
                        </tbody>
            ...
            <tr>
                <td class="ColorSpace" style="background-color: #F6E7E6;">
                    ${Space({ className: "newsletterBottomCollor80px" })}
                </td>
            </tr>
            <tr>
                <td class="ColorSpace" style="background-color: #750000;">
                    ${Space({ className: "newsletterBottomCollorTwo35px" })}
                </td>
            </tr>
            <tr>
                <td class="newsletterContainer" style="padding-top: 0px; padding-bottom: 0px; background-color: #750000;">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td align="left" style="background-color: #750000">
                                    <span class="newsletterTitleTwo" style="color: #000000">
                                        ${queries.intro[3]}
                                    </span>
                                </td>
                            </tr>
            ...
            <tr>
                <td align="center">
                    ${ImageWithLink({
                        href: links[10],
                        src: "https://upload.pictureserver.net/static/2025/2201_lemvig.gif",
                    })}
                </td>
            </tr>
            <tr>
                ...
                <td class="newsletterContainer" style="padding-top: 0px; padding-bottom: 0px; background-color: #750000;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td align="left">
                                    <span class="newsletterParagraphTwo">${queries.intro[4]}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tbody>
                            <tr>
                                <td class="newsletterBottom80px" style="padding-top: 0px; padding-left: 0px; padding-right: 0px; text-align: center; background-color: #750000;">
                                    <a href="${links[10]}" style="color: #ffffff; text-decoration: underline;">
                                        <span class="newsletterCtaTwo">${queries.shopnow[0]}</span>
                                    </a>
                                </td>
                            </tr>
                        </tbody>
