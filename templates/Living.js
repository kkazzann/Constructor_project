  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 650px; width: 100%; background-color: ${
    background || "#ffffff"
        ...
        <tbody>
            ...
            <tr>
                <td style="background-color: #DCBFBF;">
                    ${CategoryOneBanner({
            ...
            <tr>
                <td style="background-color: #FFD5CC;">
                    ${CategoryOne({
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[4].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250312category_05.png" style="display: block;" />
                                                </a>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[5].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250312category_06.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[6].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250312category_07.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
                                        ...
                                        <tr>
                                            <td style="padding-left: 0px; padding-right: 0px;">
                                                <a href=${getCategoryLink(categories[7].href)}>
                                                    <img width="100%" src="https://upload.pictureserver.net/static/2025/250312category_08.png" style="display: block;" />
                                                </a>
                                                <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tbody>
                                                        <tr>
